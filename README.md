...
```bash
docker run --name movies-api -p 8000:8050 -e APP_PORT=8050 -e JWT_SECRET=your_jwt_secret -e REFRESH_TOKEN_SECRET=your_refresh_token_secret ivanbilenkyi/movies-api
```

### Frontend

```bash
docker run -p 3000:3000 ivanbilenkyi/movies-frontend
```
